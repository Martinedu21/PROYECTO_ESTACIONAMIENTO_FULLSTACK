...
public class homeController {
    ...
    @Operation(summary = "Crear un nuevo ticket en el controlador del sistema", description = "Creacion de un nuevo ticket a partir de un vehiculo ingresado") 
    @ApiResponses(value = { 
    ...
    @Operation(summary = "Crear un nuevo estacionamiento en el controlador del sistema", description = "Creacion de un nuevo estacionamiento a partir de un vehiculo ingresado") 
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Estacionamiento creado!"), 
        @ApiResponse(responseCode = "400", description = "Solicitud invalida"),
        @ApiResponse(responseCode = "404", description = "Recurso no encontrado"),
    ...
    @PostMapping("/ingreso")
    @Operation(summary = "Crear un nuevo vehiculo en el controlador del sistema", description = "Creacion de un nuevo vehiculo para generar un ticket y un estacionamiento de forma automatica a partir de un vehiculo ingresado") 
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Vehiculo, ticket y estacionemiento creado!"), 
        @ApiResponse(responseCode = "400", description = "Solicitud invalida"),
        @ApiResponse(responseCode = "404", description = "Recurso no encontrado"),
        @ApiResponse(responseCode = "500", description = "Error interno") 
    })
